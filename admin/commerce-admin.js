...
(function(){
 ...
 function busy(btn,on,label){if(!btn)return;btn.disabled=on;if(on){btn.dataset.oldText=btn.textContent;btn.textContent=label||"Working…"}else{btn.textContent=btn.dataset.oldText||btn.textContent;delete btn.dataset.oldText}}
