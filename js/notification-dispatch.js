...
(function(){
  ...
  function dispatch(sourceTable, sourceId, customer){
    ...
    return fetch(url,{method:"POST",headers:{"Content-Type":"applicatijson","apikey":c.publishableKey,"Authorization":"Bearer "+c.publishableKey},body:JSON.stringify({source_table:sourceTable,source_id:sourceId?String(sourceId):"",customer_phone:String(customer?.phone||""),customer_email:String(customer?.email||"")})})
